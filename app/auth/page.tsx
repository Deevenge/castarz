  ...
  return (
    <main className="min-h-dvh bg-brand-ice px-4 py-6 sm:flex sm:items-center sm:justify-center sm:p-8">
      <section className="mx-auto flex w-full max-w-md flex-col sm:max-w-[440px]">
        <div className="mb-8 px-2 text-center sm:mb-6">
          <div className="mb-4 flex items-center justify-center gap-3">
            <BrandLogo priority className="h-auto w-60" />
            <ThemeToggle compact />
          </div>
          <p className="text-sm font-bold tracking-[0.24em] text-brand-blue">THE CASTING NETWORK</p>
          <h1 className="mt-2 text-3xl font-bold tracking-tight text-brand-navy">{signUp ? "Join the cast" : "Welcome back"}</h1>
          <p className="mt-2 text-base text-slate-600">{signUp ? "Start managing casting the smarter way." : "Sign in to continue to your casting workspace."}</p>
        </div>
